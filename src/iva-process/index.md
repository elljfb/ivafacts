---
layout: page.njk
title: The IVA Process - Step by Step Guide
description: A comprehensive guide to the IVA process from initial assessment through to completion, including what to expect at each stage.
---
...
[Learn more about Initial Assessment →](/iva-process/initial-assessment/)
...
[Learn how to choose an IP →](/iva-process/choosing-ip/)
...
[Understand proposal preparation →](/iva-process/proposal/)
...
[Learn about creditors' meetings →](/iva-process/creditors-meeting/)
...
[Understand living with an IVA →](/iva-process/approved-living/)
...
[Learn about completion and failure →](/iva-process/completion-failure/)
